    ...
    return(
      <section className="login">
          <div className="loginContainer">
              <img className="icon" src={process.env.PUBLIC_URL + 'logo300.png'}/>
              <h1 className="title-name">Sign in to Keryx</h1>
              <p className="description">Please enter your email<br/> and password.</p>
              <input className="email-input" type="text" autoFocus required value={email} onChange={e => setEmail(e.target.value)}/>
              <span className="floating-email">Email address</span>
              <p className="errorMsg">{emailError}</p>
              <input className="password-input" type="password" required value={password} onChange={e => setPassword(e.target.value)}/>
              <span className="floating-password">Password</span>
